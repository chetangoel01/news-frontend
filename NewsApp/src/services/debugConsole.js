// Debug console functions for local embedding system
// Call these functions from your browser/React Native console

import LocalDatabase from './localDatabase';
import embeddingService from './embeddingService';

// Global debug object that can be accessed from console
window.debugEmbedding = {
...
export default window.debugEmbedding; 